...
func initPersianTranslation() Translation {
	...
	translation.put("drawing-time-setting", "زمان هر نوبت نقاشی (ثانیه)")
	...
	translation.put("message-input-placeholder", "اینجا میتونید چت کنید")
